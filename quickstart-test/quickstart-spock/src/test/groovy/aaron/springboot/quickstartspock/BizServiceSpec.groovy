package aaron.springboot.quickstartspock.Spock

import aaron.springboot.quickstartspock.QuickstartSpockApplication
import aaron.springboot.quickstartspock.dao.BizDao
import aaron.springboot.quickstartspock.entity.PersonEntity
import aaron.springboot.quickstartspock.service.impl.BizServiceImpl
...
/**
 * BizServiceSpc xief 2019/06/28 11:27
 */
@ContextConfiguration(classes = QuickstartSpockApplication.class)
@SpringBootTest
//@ActiveProfiles("test")
class BizServiceSpec extends Specification {
    @Autowired
    private BizServiceImpl bizService;

    BizDao dao = Mock(BizDao)  // 生成dao的Mock对象
    ...
    def setup() {
        ...
        bizService = ac.getBean(aaron.springboot.quickstartspock.service.BizService.class)
    ...
    def "test isAdult"() {
        ...
        // 判断when执行bizService.isAdult(age)结果为true
        then:
        true
